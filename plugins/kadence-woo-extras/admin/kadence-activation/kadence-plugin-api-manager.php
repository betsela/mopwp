...
$kt_plugin_api->add_product( 'kt_api_manager_kadence_woo_activated', 'kt_api_manager_kadence_woo_extras_data', 'kadence_woo', 'Kadence Woo Extras', KADENCE_WOO_EXTRAS_VERSION );
