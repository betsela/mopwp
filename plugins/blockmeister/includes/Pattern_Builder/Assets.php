...
class Assets
{
    ...
    public function enqueue_styles_and_scripts()
    {
        ...
        if ( $current_screen && $current_screen->is_block_editor && use_block_editor_for_post_type( $current_screen->post_type ) ) {
     ...
     */
    public function load_domain_script_translations_filter(
        $translations,
        $file,
        $handle,
        $domain
